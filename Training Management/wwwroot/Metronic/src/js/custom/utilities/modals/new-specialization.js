...
var KTModalNewTarget = function () {
	...
	var handleForm = function () {
		...
		function submitId() {
			...
			let data = $("#kt_modal_new_specialization_form").serialize();
			let formData = new FormData();
			formData.append("Name", $("#name_name").val());

			$.ajax({
				type: 'POST',
				url: '/ControlPanel/AdminSpecialization/Create',
	...
	return {
		...
		init: function () {
			// Elements
			modalEl = document.querySelector('#kt_modal_new_specialization');
			...
			form = document.querySelector('#kt_modal_new_specialization_form');
			submitButton = document.getElementById('kt_modal_new_specialization_submit');
			cancelButton = document.getElementById('kt_modal_new_specialization_cancel');
