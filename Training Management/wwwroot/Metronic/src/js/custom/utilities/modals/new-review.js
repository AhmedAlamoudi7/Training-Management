...
var KTModalNewTarget = function () {
	...
	var handleForm = function () {
		...
		function submitId() {
			...
			let data = $("#kt_modal_new_review_form").serialize();
			let formData = new FormData();
			formData.append("Description", $("#name_description").val());
			formData.append("SpecializationId", special);
			formData.append("FullName", $("#name_fullname").val());
			formData.append("Image", image);
 
			$.ajax({
				type: 'POST',
				url: '/ControlPanel/AdminReview/Create',
	...
	return {
		...
		init: function () {
			// Elements
			modalEl = document.querySelector('#kt_modal_new_review');
			...
			form = document.querySelector('#kt_modal_new_review_form');
			submitButton = document.getElementById('kt_modal_new_review_submit');
			cancelButton = document.getElementById('kt_modal_new_review_cancel');
