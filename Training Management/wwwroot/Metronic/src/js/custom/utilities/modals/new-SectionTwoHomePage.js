...
var KTModalNewTarget = function () {
	...
	var handleForm = function () {
		...
		function submitId() {
			...
			let data = $("#kt_modal_new_SectionTwoHomePage_form").serialize();
			...
			$.ajax({
				type: 'POST',
				url: '/ControlPanel/AdminHomePage/CreateSectionTwoHomePage',
	...
	return {
		...
		init: function () {
			// Elements
			modalEl = document.querySelector('#kt_modal_new_SectionTwoHomePage');
			...
			form = document.querySelector('#kt_modal_new_SectionTwoHomePage_form');
			submitButton = document.getElementById('kt_modal_new_SectionTwoHomePage_submit');
			cancelButton = document.getElementById('kt_modal_new_SectionTwoHomePage_cancel');
