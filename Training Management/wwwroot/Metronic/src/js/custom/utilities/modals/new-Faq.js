...
var KTModalNewTarget = function () {
	...
	var handleForm = function () {
		...
		function submitId() {
			...
			let data = $("#kt_modal_new_faq_form").serialize();
			...
			$.ajax({
				type: 'POST',
				url: '/ControlPanel/AdminFAQ/Create',
	...
	return {
		...
		init: function () {
			// Elements
			modalEl = document.querySelector('#kt_modal_new_faq');
			...
			form = document.querySelector('#kt_modal_new_faq_form');
			submitButton = document.getElementById('kt_modal_new_faq_submit');
			cancelButton = document.getElementById('kt_modal_new_faq_cancel');
