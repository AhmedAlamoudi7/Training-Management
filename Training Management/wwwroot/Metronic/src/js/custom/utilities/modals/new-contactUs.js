...
var KTModalNewTarget = function () {
	...
	var handleForm = function () {
		...
		function submitId() {
			...
			let data = $("#kt_modal_new_ContactUs_form").serialize();
			let formData = new FormData();
			formData.append("Title", $("#name_title").val());
			formData.append("Id", $("#name_Id").val());
			formData.append("Email", $("#name_Email").val());
			formData.append("Message", $("#name_message").val());

			$.ajax({
				type: 'POST',
				url: '/ControlPanel/AdminContactUs/ReplyMessage',
				...
				success: function (response) {
					if (response.success) {
						...
						Swal.fire({
								...
								confirmButtonText: "تمت الرد بنجاح",
								customClass: {
	...
	return {
		...
		init: function () {
			// Elements
			modalEl = document.querySelector('#kt_modal_new_ContactUs');
			...
			form = document.querySelector('#kt_modal_new_ContactUs_form');
			submitButton = document.getElementById('kt_modal_new_ContactUs_submit');
			cancelButton = document.getElementById('kt_modal_new_ContactUs_cancel');
