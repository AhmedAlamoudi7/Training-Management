...
var KTModalNewTarget = function () {
	...
	var handleForm = function () {
		...
		function submitId() {
			...
			$.ajax({
				type: 'POST',
				url: '/ControlPanel/AdminUsagePolicy/Edit/'+ id+'',
	...
	return {
		...
		init: function () {
			// Elements
			modalEl = document.querySelector('#kt_modal_new_usagepolicy');
			...
			form = document.querySelector('#kt_modal_new_usagepolicy_form');
			submitButton = document.getElementById('kt_modal_new_usagepolicy_submit');
			cancelButton = document.getElementById('kt_modal_new_usagepolicy_cancel');
